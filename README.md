...
三個單元：其他形容詞 66 字、人物 16 字、其他副詞 14 字
...
| | 學生 | 老師 |
|---|---|---|
| 測驗（練習／考試／總複習／文章／單字表） | ✅ | ❌ 不顯示 |
| 我的錯題紀錄、錯題重練 | ✅ | ❌ |
| 老師指派的考卷 | ✅ | — |
| 學生學習報告（熱力圖、弱點、常錯單字、成績） | ❌ | ✅ |
| 產生錯題考卷（列印／指派） | ❌ | ✅ |
...
老師報告最上面有一張 GitHub 那種的熱力圖：一格是一天（一欄是一週，由上到下
週日到週六），學生那天做越多次測驗顏色越深，旁邊列出半年內的總次數、
有練習的天數、最長連續與目前連續天數。

計數存在 `profile.days`（`{ 20260915: 3 }`），跟只保留最近 60 筆的作答紀錄分開，
所以看得到半年；回報碼與雲端同步都會一起帶過去。
...
返回鍵一律放在畫面最上面（不用捲到底才找得到），九個畫面都一樣。
